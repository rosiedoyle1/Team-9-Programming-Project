class HomePage {
  ...
  PFont stdFont = loadFont("ArialRoundedMTBold-40.vlw");
  ...
  HomePage() 
  {
    ...
    widget2 = new Widget(15, 330, 400, 590, "Flights", color(230, 240, 255, 175), stdFont, EVENT_BUTTON2);
    widget3 = new Widget(430, 15, 450, 475, "Airports", color(153, 194, 255, 175), stdFont, EVENT_BUTTON3);
    widget4 = new Widget(430, 500, 450, 420, "Dates", color(153, 221, 255, 175), stdFont, EVENT_BUTTON4);
    widget5 = new Widget(890, 15, 500, 400, "Lateness", color(179, 204, 255, 175), stdFont, EVENT_BUTTON5);
    widget6 = new Widget(890, 425, 500, 490, "Destination Popularity", color(179, 240, 255, 175), stdFont, EVENT_BUTTON6);
    widget7 = new Widget(1400, 15, 500, 450, "Diverted", color(153, 204, 255, 175), stdFont, EVENT_BUTTON7);
